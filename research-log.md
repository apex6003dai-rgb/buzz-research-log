...
自己啓発系ショート動画(TikTok/YouTube Shorts/Instagram Reels)がバズるための方法論に関する日次リサーチメモ。

## 2026-09-15

短尺動画がバズるには冒頭1.5〜3秒の「フック」が最重要で、「実は〜」「多くの人が誤解している〜」のような意外性・共感訴求のフックは、ありきたりな「最後まで見て」系より3秒完視聴率が35〜45%高い傾向。テンポの速いカット割り、トレンド音源、無音でも内容が伝わるテロップ(字幕)が視聴維持率を左右する。アルゴリズムは完視聴率・リプレイ・保存・シェアを重視するが強弱があり、TikTokは視聴継続率、YouTube Shortsは視聴後のコメント・チャンネル登録等のエンゲージメント、Instagram Reelsは保存とシェアを特に評価する傾向がある。視聴者心理としてはFOMO(見逃し不安)、社会的証明、「区切りの良いところまで見たい」完了欲求、トレンド音源による高揚感がシェア・最後まで視聴する動機になる。投稿後は伸びた型をデータで分析し、当たった構成を反復・改善するサイクルが継続的なバズの鍵。

**参考情報源:**
- [Short-Form Video Strategy: The Complete 2026 Guide | Teleprompter.com](https://www.teleprompter.com/blog/short-form-video-strategy)
- [The 5 TikTok Hook Types That Actually Go Viral in 2026](https://www.opus.pro/blog/tiktok-hooks-that-go-viral-2026)
- [YouTube Shorts Algorithm 2026: How It Works & How To Win](https://www.socialchamp.com/blog/youtube-shorts-algorithm/)
- [Why The First 3 Seconds of Video Matter More Than the Next 30 - Animoto](https://animoto.com/blog/video-marketing/why-first-3-seconds-matter)
- [バズるショート動画の作り方 画角・テロップ・効果音 - Impress Watch](https://www.watch.impress.co.jp/docs/pa/impress/1573429.html)
- [バズるYouTubeショート動画とは？株式会社Funusual](https://funusual.co.jp/media/column/short-video-go-viral/)

## 2026-09-16

視聴維持率を左右するのは冒頭1.5〜3秒で、ここが弱いと即離脱される。特に伸びやすいフックは「完成品・変化後の結果を先に見せる」型で、平均視聴数が最下位のフック形式の約2倍という調査もある。心理面では、脳は未完了のパターン(オープンループ)を嫌い、続きが気になる構成が離脱を防ぐ。またシェアは「動画の質」より「自分が賢く見える・共感できる・仲間意識を刺激される」かどうかで決まり、終わり方(最後の2秒)がシェア率を大きく左右する。キャプションはプラットフォームで最適解が異なり、TikTokは検索性の高い短文+ハッシュタグ3〜5個とコメントを誘う問いかけ、Instagramはやや長めの共感キャプション、YouTubeはタイトル・サムネイルのSEOが重視される。アルゴリズムの評価軸もTikTokは視聴継続率、YouTube Shortsは視聴後のコメント・登録等のエンゲージメント、Instagram Reelsは保存・シェアと、プラットフォームごとに強弱がある点は前日の調査と一致。
